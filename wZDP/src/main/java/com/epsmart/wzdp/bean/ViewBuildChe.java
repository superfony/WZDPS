...
public class ViewBuildChe extends ViewBuilder<WorkOrder> {
...
//			holder.time.setText(field.fieldChName + ":");
			if(field.fieldChName.contains("项目状态1")){
//				int info=Integer.valueOf(field.fieldContent);
//				String newinfo = ""+info;
				holder.time.setText("项目状态"+":");
				}
