 ...
 * 
 */
public class DepartureFormFragment extends ContractFragment {
	...
	private String TAG = DepartureFormFragment.class.getName();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_scene_pro_check, container,
				false);
		return view;
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		if (PermissHelp.getUserType("000").equals("8")) {// 施工单位
	...
	public void loadData(RequestPram param) {
		...
		requestPram.methodName = RequestParamConfig.DeldepartureDownload;
	...
	protected void submitMethod(RequestPram reqPram) {
		...
		requestPram.pluginId = 119;
		requestPram.userName = appContext.user.getUid();
		requestPram.methodName = RequestParamConfig.Deldepartureupload;
