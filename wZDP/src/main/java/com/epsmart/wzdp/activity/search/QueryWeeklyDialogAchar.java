...
public class QueryWeeklyDialogAchar {
	private static final String TAG = QueryWeeklyDialogAchar.class.getName();
	...
	public QueryWeeklyDialogAchar(final Activity activity, final QueryDialogListener listener) {
