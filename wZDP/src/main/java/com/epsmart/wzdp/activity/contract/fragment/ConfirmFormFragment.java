 ...
 * 
 */
public class ConfirmFormFragment extends ContractFragment{
	...
	private String TAG = ConfirmFormFragment.class.getName();
	@Override
	...
	public void loadData(RequestPram param) {
		...
		requestPram.methodName=RequestParamConfig.delconfirmDownload;
	...
	protected void submitMethod(RequestPram reqPram) {
		...
		requestPram.pluginId=119;
		requestPram.userName=appContext.user.getUid();
		requestPram.methodName =RequestParamConfig.delconfirmupload;
