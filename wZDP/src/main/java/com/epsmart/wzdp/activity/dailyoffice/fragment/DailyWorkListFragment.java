 ...
 * 新建工作表单
 */
public class DailyWorkListFragment extends SceneFragmemt {
	private View view;
	protected WorkOrder workOrder;
	private BasicResponse response;
	private BasicResponseNew responseNew;
	private String TAG = DailyWorkListFragment.class.getName();
...
//		requestPram.param = fillHelpNew.getparams(getArguments().getString("reqParam"));
