...
public class QueryPlanDialog {
	private static final String TAG = QueryPlanDialog.class.getName();
	...
	public QueryPlanDialog(final Activity activity,
		...
		query.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				String types = ((CommonReqAct) activity).getTypes();
				String type = null;
				...
				req = RequestXmlHelp.getCommonXML(RequestXmlHelp.getReqXML(
						"version", et_one.getText().toString())
						.append(RequestXmlHelp.getReqXML("pspid",((CommonReqAct) activity).getPspid()))
						.append(RequestXmlHelp.getReqXML("type",type)));
