 ...
 * 工作日志
 */
public class ItemProWorkFragment extends SceneFragmemt {
	//private Activity activity;
	private View view;
	// 初始化分页标签
	private ViewBuildWork viewBuildWork;
	private String TAG = ItemProWorkFragment.class.getName();
		...
		paginationWidget
				.setPageBodyOnItemClickListener(paginationWidget.new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						ProWorkFragment workfragment = new ProWorkFragment();
...
//				PermissHelp.getUserType("000").equals("4")
	...
	OnClickListener addOnLister = new OnClickListener() {
		...
		public void onClick(View v) {
			activity.setSmGone();
			NewProWorkFragment prowork = new NewProWorkFragment();
			Bundle bundle = new Bundle();
			bundle.putString("reqParam", RequestXmlHelp
