...
public class HosoolListTt extends CommonReqAct {
	...
	public void initview() {
		...
		if ("tower".equals(getIntent().getStringExtra("types"))) {// 铁塔
			appContext.wzdpTypes = WZDPTYPES.tower_plan;
			title_image.setBackgroundResource(R.drawable.plan_cs);
		} else if ("porcelain".equals(getIntent().getStringExtra("types"))) {// 瓷
			appContext.wzdpTypes = WZDPTYPES.porcelain_plan;
			title_image.setBackgroundResource(R.drawable.ci_plan);
		} else if ("reunite".equals(getIntent().getStringExtra("types"))) {// 复合
			appContext.wzdpTypes = WZDPTYPES.reunite_plan;
			title_image.setBackgroundResource(R.drawable.fuhe_plan);
		} else if ("wireway".equals(getIntent().getStringExtra("types"))) {// 导线
			appContext.wzdpTypes = WZDPTYPES.wireway_plan;
			title_image.setBackgroundResource(R.drawable.dao_plan);
		} else if ("ground".equals(getIntent().getStringExtra("types"))) {// 地线
			appContext.wzdpTypes = WZDPTYPES.ground_plan;
			title_image.setBackgroundResource(R.drawable.di_plan);
		} else if ("cable".equals(getIntent().getStringExtra("types"))) {// 光缆
			appContext.wzdpTypes = WZDPTYPES.cable_plan;
			title_image.setBackgroundResource(R.drawable.guang_plan);
		} else if ("fittings".equals(getIntent().getStringExtra("types"))) {// 金具
			appContext.wzdpTypes = WZDPTYPES.fittings_plan;
			title_image.setBackgroundResource(R.drawable.jinju_plan);
		}
	...
	protected OnClickListener searchLisp = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			activity.setTypes(getIntent().getStringExtra("types"));
