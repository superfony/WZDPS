...
public class QueryScheduleDialogAchar {
	private static final String TAG = QueryScheduleDialogAchar.class.getName();
	...
	public QueryScheduleDialogAchar(final Activity activity, final QueryDialogListener listener) {
		this.mActivity = activity;
		this.listener = listener;
		layoutInflater = (LayoutInflater) mActivity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		popView = LayoutInflater.from(mActivity).inflate(R.layout.tower_query, null);
