...
public class UIHelper {
	...
	public final static int LISTVIEW_ACTION_INIT = 0x01;// 动作标示  首次默认初始化加载
	public final static int LISTVIEW_ACTION_REFRESH = 0x02;// 下拉刷新
	public final static int LISTVIEW_ACTION_SCROLL = 0x03;//   上托加载更多
