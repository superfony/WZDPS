 ...
 * 
 */
public class ProCheckFragment extends SceneFragmemt{
	...
	private String TAG = ProCheckFragment.class.getName();
	@Override
	...
	public void loadData(RequestPram param) {
		...
		requestPram.methodName=RequestParamConfig.materialsReceiveReq;
...
//				new ProcessResponse(), RequestType.THRIFT);
	...
	protected void submitMethod(RequestPram reqPram) {
		...
		requestPram.pluginId=119;
		requestPram.userName=appContext.user.getUid();
		requestPram.methodName =RequestParamConfig.projectReceiveUpload;
