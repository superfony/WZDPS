...
import com.epsmart.wzdp.activity.AppException;
...
public class Update implements Serializable{
	...
	public final static String NODE_ROOT = "wzdp";
	...
	public String toString() {
		return "[versionCode="+versionCode+", versionName="+versionName+",downloadUrl="+downloadUrl+",updateLog="+updateLog+"]";
