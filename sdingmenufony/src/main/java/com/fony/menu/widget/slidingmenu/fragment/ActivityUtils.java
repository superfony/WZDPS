...
public class ActivityUtils {
	 ...
	 */
	public static void setScreeBrightness(final Activity mActivity,
	...
	public static <T> void doAsync(final Context pContext,
		...
		ActivityUtils.doAsync(pContext, pTitleResourceID, pMessageResourceID,
	...
	public static <T> void doAsync(final Context pContext,
		...
		ActivityUtils.doAsync(pContext, pTitleResourceID, pMessageResourceID,
				pCallable, pCallback, null, pCancelable);
	}
	...
	public static <T> void doAsync(final Context pContext,
		...
		ActivityUtils.doAsync(pContext, pTitleResourceID, pMessageResourceID,
				pCallable, pCallback, pExceptionCallback, false);
	}
	...
	public static <T> void doAsync(final Context pContext,
			...
			final Callback<Exception> pExceptionCallback,
			final boolean pCancelable) {
		ActivityUtils.doAsync(pContext, pContext.getString(pTitleResourceID),
				pContext.getString(pMessageResourceID), pCallable, pCallback,
	...
	public static <T> void doProgressAsync(final Context pContext,
			final int pTitleResourceID, final int pIconResourceID,
			final ProgressCallable<T> pCallable, final Callback<T> pCallback) {
		ActivityUtils.doProgressAsync(pContext, pTitleResourceID,
				pIconResourceID, pCallable, pCallback, null);
	}

	public static <T> void doProgressAsync(final Context pContext,
			final CharSequence pTitle, final int pIconResourceID,
			final ProgressCallable<T> pCallable, final Callback<T> pCallback) {
		ActivityUtils.doProgressAsync(pContext, pTitle, pIconResourceID,
				pCallable, pCallback, null);
	}
	...
	public static <T> void doProgressAsync(final Context pContext,
			...
			final ProgressCallable<T> pCallable, final Callback<T> pCallback,
			final Callback<Exception> pExceptionCallback) {
		ActivityUtils.doProgressAsync(pContext,
				pContext.getString(pTitleResourceID), pIconResourceID,
	...
	public static <T> void doAsync(final Context pContext,
			...
			final Callback<Exception> pExceptionCallback) {
		ActivityUtils.doAsync(pContext, pContext.getString(pTitleResourceID),
				pContext.getString(pMessageResourceID), pAsyncCallable,
	...
	public static <T> void doAsync(final Context pContext,
			...
			final AsyncCallable<T> pAsyncCallable, final Callback<T> pCallback,
			final Callback<Exception> pExceptionCallback) {
		final ProgressDialog pd = ProgressDialog.show(pContext, pTitle,
				pMessage);
